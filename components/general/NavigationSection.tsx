      ...
      <NavigationMenu className="  min-w-[98dvw] sticky top-0 ">
        <NavigationMenuList className=" flex py-2">
          <NavigationMenuItem className="pl-1 flex-1 md:pl-10">
            <NavigationMenuLink href="/" className="bg-transparent hover:bg-transparent">
              <Image
                src={NaiMediaLogo}
                alt="Logo"
                width={400}
            ...
            <div className="grid place-content-center mr-0 lg:mr-40">
              <NavigationMenuItem>
                {navLinks.map((link) => (
                  <NavigationMenuLink
                    key={link.id}
                    className={cn (navigationMenuTriggerStyle(),"font-bold hover:bg-fuchsia-200")}
          ...
          <div className="block  lg:hidden">
              ...
              <NavigationMenuItem>
                {navLinks.map((link) => (
                  <NavigationMenuLink
                    key={link.id}
                    className={cn( navigationMenuTriggerStyle(), "block my-4")}
                    render={<Link href={link.href}>{link.title}</Link>}
                    href={link.href}
