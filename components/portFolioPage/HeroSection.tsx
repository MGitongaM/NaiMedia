export default function HeroSection() {
  return (
    ...
    <section className=" bg-slate-200 bg-[url('https://res.cloudinary.com/hqho8qw7/image/upload/v1789023335/portfolio_page_bg-image.jpg')]   bg-cover bg-center bg-no-repeat relative min-h-[80dvh] z-10">
      <div className="min-h-[80dvh] w-full absolute top-0 bg-black/70"></div>
