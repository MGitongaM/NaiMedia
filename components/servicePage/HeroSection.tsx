export default function HeroSection() {
  return (
    <>
      <section className="bg-gray-200 bg-[url('https://res.cloudinary.com/hqho8qw7/image/upload/v1789022863/services_page_bg_image.jpg')]   bg-cover bg-center bg-no-repeat relative min-h-[85dvh] z-10">
      <div className="min-h-[85dvh] w-full absolute top-0 bg-black/70"></div>
