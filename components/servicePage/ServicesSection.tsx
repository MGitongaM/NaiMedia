      ...
      <div className="container mx-auto px-4 py-20 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-20">
          {servicesOfferingData.map((service) => (
            ...
            >
              <div className="col-span-12 md:col-span-8 px-3 py-6">
                <h2 className="text-xl font-semibold">{service.title}</h2>
                <p
                  className="leading-7 my-10"
                  dangerouslySetInnerHTML={{ __html: service.description }}
                />
              </div>
              <div className="col-span-12 md:col-span-4 px-3 py-6">
                <CloudinaryImage
                  ...
                  classNames={
                    "object-cover h-96 lg:h-60 w-full group-hover:scale-105 transition-transform duration-700  rounded-lg"
                  }
                />
              </div>
            </div>
