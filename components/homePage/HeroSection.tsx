...
export default function HeroSection() {
  return (
    <>
      ...
      <section className="bg-gray-700 bg-[url('https://res.cloudinary.com/hqho8qw7/image/upload/v1788874114/home-hero-bg.jpg')] bg-cover bg-center bg-no-repeat  min-h-[85dvh] z-10">
      {/* <section className="bg-slate-900/60 relative  h-dvh "> */}
        ...
        <div className="container mx-auto text-balance  px-4 py-20 relative z-30">
          ...
          <h1 className="text-6xl text-slate-100 md:text-7xl font-bold mt-20 mb-4">
            Create Events with Precision and Passion
          </h1>
            <p className="text-xl font-semibold text-slate-100  mt-10 mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 my-8">
              <Link href="/contact-us">
                <Button className="bg-green-600 hover:bg-blue-400 cursor-pointer text-white text-xl hover:scale-105 transition-all transition-discrete ease-linear duration-500 shadow-md font-bold py-8 px-4 rounded-sm">
                  Request a Quote
                </Button>
              </Link>
              <Link href="/our-services">
                <Button
                  variant="secondary"
                  className="bg-green-100 hover:bg-blue-200 cursor-pointer text-slate-800 text-xl hover:scale-105 transition-all transition-discrete ease-linear duration-500 shadow-md font-bold py-8 px-4 rounded-lg"
                >
                  Our Services
                </Button>
              </Link>
